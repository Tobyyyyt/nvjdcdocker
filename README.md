...
国内
```
git clone https://ghproxy.com/https://github.com/Tobyyyyt/nvjdcdocker.git /root/nolanjdc
```
国外
```
git clone https://github.com/Tobyyyyt/nvjdcdocker.git /root/nolanjdc
```


2 拉取基础镜像以后不需要拉取镜像了 如果需要拉取我会通知
```
sudo docker pull shifanga/nolanhzy:latest
```
...
国内请使用
 ```
wget -O Config.json   https://ghproxy.com/https://raw.githubusercontent.com/Tobyyyyt/nvjdc/main/Config.json
```
